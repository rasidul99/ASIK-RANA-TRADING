      ...
      <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-8 sm:mb-12 md:mb-18">
          ...
          <motion.h2
            ...
            className={`font-serif text-2xl sm:text-3xl md:text-[46px] font-normal mt-3 sm:mt-4 mb-2 sm:mb-3 tracking-tight max-w-[860px] bg-gradient-to-b from-white via-[#EEEEEE] to-[#9E9E9E] bg-clip-text text-transparent ${
